...
object DOMElement {
  @scala.inline
  def apply[/* <: typings.react.mod.HTMLAttributes[T] | typings.react.mod.SVGAttributes[T] */ P, /* <: typings.std.Element */ T](props: js.Any, ref: Ref[T], `type`: String): DOMElement[P, T] = {
