...
package object optionsMod {
  ...
  {[ K in keyof T ]: (): T[K] | vue.vue/types/options.ComputedOptions<T[K]>}
    */ typings.vue.vueStrings.Accessors & org.scalablytyped.runtime.TopLevel[js.Any]
  ...
  ]) & (typings.std.ThisType[typings.vue.vueMod.CombinedVueInstance[V, Data, Methods, Computed, Props]])
